      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-4">
            <div className="price">
              <div className="price__img">
                <img src="/assets/img/pizza2.png" alt="pizza" />
              </div>
              <h1 className="price__heading">Pizza Margeritta</h1>
              <p className="price__text">
                Nullam nibh sem, imperdiet ultrices commodo a, vulputate vel
          ...
          <div className="col-4">
            <div className="price">
              <div className="price__img">
                <img src="/assets/img/pizza3.png" alt="pizza" />
              </div>
              <h1 className="price__heading">Pizza Margeritta</h1>
              <p className="price__text">
                Nullam nibh sem, imperdiet ultrices commodo a, vulputate vel
          ...
          <div className="col-4">
            <div className="price">
              <div className="price__img">
                <img src="/assets/img/pizza4.png" alt="pizza" />
              </div>
              <h1 className="price__heading">Pizza Margeritta</h1>
              <p className="price__text">
                Nullam nibh sem, imperdiet ultrices commodo a, vulputate vel
          ...
          <div className="col-4">
            <div className="price">
              <div className="price__img">
                <img src="/assets/img/pizza5.png" alt="pizza" />
              </div>
              <h1 className="price__heading">Pizza Margeritta</h1>
              <p className="price__text">
                Nullam nibh sem, imperdiet ultrices commodo a, vulputate vel
          ...
          <div className="col-4">
            <div className="price">
              <div className="price__img">
                <img src="/assets/img/pizza6.png" alt="pizza" />
              </div>
              <h1 className="price__heading">Pizza Margeritta</h1>
              <p className="price__text">
                Nullam nibh sem, imperdiet ultrices commodo a, vulputate vel
